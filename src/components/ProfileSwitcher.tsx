      ...
      <div className="flex items-center gap-2">
        {activeProfile ? (
          ...
          <button className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-secondary/50 hover:bg-secondary text-sm font-medium transition-all hover:scale-105 active:scale-95 group">
            <span 
              className="flex items-center justify-center w-6 h-6 rounded-full transition-transform group-hover:rotate-12 border-2 border-slate-900 shadow-[0_0_2px_rgba(0,0,0,0.8)]" 
            ...
            <DropdownMenuContent align="end" className="w-64 p-2 bg-card/95 backdrop-blur-md border-border shadow-xl">
              ...
              <div className="flex items-center gap-3">
                <span className="flex items-center justify-center w-8 h-8 rounded-full text-lg shadow-sm border-2 border-slate-900 shadow-[0_0_2px_rgba(0,0,0,0.8)]" style={{ backgroundColor: p.color, color: '#4B5563', textShadow: '0 0 1px black' }}>
                  {p.icon}
                </span>
                    <span className={cn(
